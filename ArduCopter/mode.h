...
public:
    ...
    enum class Number : uint8_t {
        ...
        LOITERF =      27,  // Fast loiter mode with max speed higher than normal loiter
    };
...
protected:
    ...
    const char *name() const override { return "LOITERF"; }
    const char *name4() const override { return "LOITF"; }
